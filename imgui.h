...
namespace ImGui
{
    ...
    IMGUI_API void          SetWindowIcon(ImTextureID icon_id);                                         // [Custom] Set icon for current window.   
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_HasIcon                = 1 << 20,  // Custom: Window has an icon in title-bar and tabs
